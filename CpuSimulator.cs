...
namespace Samples.CSharp
{
    class CpuSimulator : ISimulator, ISimulatorTester
    {
        ...
        public void RunNBodySim(deviceptr<float4> newPos, deviceptr<float4> oldPos, deviceptr<float4> vel, int numBodies, float deltaTime, float softeningSquared,
            float damping)
        {
        ...
        public float gborder { get => throw new System.NotImplementedException(); set => throw new System.NotImplementedException(); }
    }
}
